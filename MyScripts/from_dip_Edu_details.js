$(function () {
    ...
    $("#eduDetails_1").on("submit", (e) => {
        ...
        const stu1_detail = {
            ...
            dipRegNo: $("#dipRegNo").val(),
            dipPercentage: $("#dipPercentage").val(),
            dipCollegeName: $("#dipcollegeName").val(),
            dipBoard: $("#dipBoard").val(),
            dipcollegeState: $("#dipCollegeState").val(),
            dipPassYear: $("#dipPassYear").val(),
            diptotalMarks: $("#dipTotalMarks").val(),

        }
        alert("dip Coled  :  " + stu1_detail.dipCollegeName)
        // return
        ...
        $.ajax({
            url: "http://localhost:3500/dipEducationDetails",
            type: "post",
            data: stu1_detail,
